    ...
    <div class="section-inner content-inner">
      ...
      <section class="digital-era">
        ...
        <div class="digital-era-img-wrapper">
          ...
          <div class="left-upward-arrow">
            <img src="<?php echo get_template_directory_uri() . '/assets/patterns/left-upward-arrow.svg' ?>" alt="" aria-hidden="true" />
          </div>

          <img src="<?php echo get_template_directory_uri() . '/assets/images/digital-era.jpg'?>"  class="img-digital-era" alt="" aria-hidden="true" />
      ...
      <section class="better-living">
        ...
        <div class="better-living-img-wrapper">
          ...
          <img src="<?php echo get_template_directory_uri() . '/assets/images/better-living.jpg' ?>" class="img-better-living" alt="" aria-hidden="true" />
      ...
      <section class="faq-how-it-works">
        ...
        <article class="faq">
          ...
          <div class="faq-question">
            ...
            <span class="faq-toggle-answer"><img src="<?php echo get_template_directory_uri() . '/assets/icons/chevron.svg' ?>" alt="" aria-hidden="true" /></span>
          </div> <!-- .faq-question -->
